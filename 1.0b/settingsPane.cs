...
namespace Browser
{
    public partial class settingsPane : Form
    {
        ...
        {
                oldSearchEngine = MainWindow.searchEngine;
        ...
        {
            bool oldStatus = MainWindow.showStatus;
            MainWindow.showStatus = checkBox4.Checked;
